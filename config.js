module.exports = {
	...
	adminId: "933250501624098816", //- Replace UserId with the Discord ID of the admin of the bot
	token: process.env.token || "MTEyMTY4MTAyOTY5OTIxMTMwNA.G65GRe.InP1-uuljyGqvlVLU-l24nb631PpNhVLElcXLo", //- Bot's Token
	clientId: process.env.clientId || "1121681029699211304", //- ID of the bot
	clientSecret: process.env.clientSecret || "Te0bvZmUdPe4FVrQmXXTW0i7HVOvNZ3H", //- Client Secret of the bot
	port: 4200, //- Port of the API and Dashboard
	scopes: ["identify", "guilds", "applications.commands"], //- Discord OAuth2 Scopes
	inviteScopes: ["bot", "applications.commands"], // Invite link scopes
	serverDeafen: true, //- If you want bot to stay deafened
	defaultVolume: 100, //- Sets the default volume of the bot, You can change this number anywhere from 1 to 100
	supportServer: "https://instagram.com/hapisd1", //- Support Server Link
	...
	nodes: [
		{
			...
			host: "lavalinkv4.serenetia.com", //- The host name or IP of the lavalink server.
			port: 443, // The port that lavalink is listening to. This must be a number!
			password: "https://seretia.link/discord", //- The password of the lavalink server.
